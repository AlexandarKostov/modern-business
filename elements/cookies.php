<!-- Page Content-->
<!-- This files need to be scripted before usage -->
...
<div class="fixed-bottom">
    <div class="alert alert-custom alert-primary d-flex align-items-center alert-dismissible fade show" role="alert">
